...
/* 	var questionTitleObj = document.getElementById("questionTitle");
  ...
  <body style="margin:0px;height: 760px;width:100%">
	<div class="warpper">
		...
		<form  action="<%=PathUtil.getFullPath("admin/editMajorAction")%>" method="POST" id="editForm">
		<div class="center_question">
			<label >班级名&nbsp;:</label>
			<input id="majorName" name="majorName" value="${majorName }" style="width:173px;height:21px; position: absolute; left:150px;top:0px;"/>
