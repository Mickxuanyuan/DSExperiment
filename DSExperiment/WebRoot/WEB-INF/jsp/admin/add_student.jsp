  ...
  <body style="margin:0px;height: 760px;width:100%">
	<div class="warpper">
		...
		<div class="main_center_top">
			<label>学生列表&nbsp;--</label><label class="edit_question_id_l">添加学生&nbsp;--</label>
		</div>
		<form  action="<%=PathUtil.getFullPath("admin/addStudentAction")%>" method="POST" id="editForm">
		<div class="center_question">
			<label >学生学号&nbsp;:</label>
			<input id="teacherId" name="teacherId" style="width:173px;height:21px; position: absolute; left:150px;top:0px;"/>
			<label class="edit_question_center_title_l" style="top:50px">学生姓名&nbsp;:</label>
			<input class="edit_question_center_title" style="top:50px" id="teacherName" name="teacherName"/>
			<label class="edit_question_center_title_l" >电话&nbsp;:</label>
			<input class="edit_question_center_title" id="teacherTel" name="teacherTel"></input>
			<label class="edit_question_center_discription_l" >邮箱&nbsp;:</label>
			<input class="edit_question_center_title" style="top:150px" id="teacherEmail" name="teacherEmail"/>
			<label class="edit_question_center_discription_l" style="top:200px">班级&nbsp;:</label>
