  ...
  <body style="margin:0px;height: 760px;width:100%">
	<div class="warpper">
		...
		<div class="main_center_top">
			<label>老师列表&nbsp;--</label><label class="edit_question_id_l">添加老师&nbsp;--</label>
		</div>
		<form  action="<%=PathUtil.getFullPath("admin/addTeacherAction")%>" method="POST" id="editForm">
		<div class="center_question">
			...
			<div class="edit_question_center_title" style="top:200px;overflow: auto;height:200px;">
				<c:forEach items="${majorList}" var="o">
					<label><input name="class" type="checkbox" value="${o.id}"/>${o.name}</label>
					<br/>
				</c:forEach>
			</div>
