...
<script>
	...
	function runToChangePassword() {
		var turnUrl = "<%=PathUtil.getFullPath("student/changePassword")%>";
		window.location.href = turnUrl;
	}
...
<body style="margin:0px;height: 760px;width:100%">
	<div class="warpper">
		...
		<div class="breadcrumb">
			...
			<div class="breadcrumb_home" style="background:#D2DAE3;cursor: pointer;" onclick="runToPersonalHome()">个人主页</div>
		</div>
		...
		<div class="center_main">
			...
			<div class="main_right">
				...
				<div class="div_main_center" style="width:300px;left:300px;border:none;">
					...
					<label style="width: 100px;height:30px;position: absolute; left:0px;top:120px;">专业班级&nbsp;:</label>
					<label class="chapter_select_major" style="width:178px;height:25px;position: absolute; left:150px;top:120px;">${user.majorName}</label>
					
					<label style="width: 100px;height:30px;position: absolute; left:0px;top:180px;">电话号码&nbsp;:</label>
					<label class="chapter_select_question_number" style="width:178px;height:25px;position: absolute; left:150px;top:180px;" >${user.telephone}</label>
					
					<label style="width: 100px;height:30px;position: absolute; left:0px;top:240px;">邮箱&nbsp;:</label>
					<label class="chapter_select_question_number" style="width:178px;height:25px;position: absolute; left:150px;top:240px;" >${user.email}</label>
				</div>
			</div>
		</div>
	</div>
