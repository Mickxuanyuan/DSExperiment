	...
	<div class="warpper">
		...
		<div class="center_main">
			...
			<div class="main_left">
				...
				<div class="1" onclick="initialColor('1')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#2E4358;font-family:Arial;color: #ffffff;position: absolute;top:51px">第
					1 章 绪论</div>
				<hr style="width:180px; position:absolute; top:80px;margin:0px" />
				<div class="2" onclick="initialColor('2')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:81px">第
					2 章 线性表</div>
				<hr style="width:180px; position:absolute; top:110px;margin:0px" />
				<div class="3" onclick="initialColor('3')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:111px">第
					3 章 栈和队列</div>
				<hr style="width:180px; position:absolute; top:140px;margin:0px" />
				<div class="4" onclick="initialColor('4')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:141px">第
					4 章 串</div>
				<hr style="width:180px; position:absolute; top:170px;margin:0px" />
				<div class="5" onclick="initialColor('5')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:171px">第
					5 章 数组和广义表</div>
				<hr style="width:180px; position:absolute; top:200px;margin:0px" />
				<div class="6" onclick="initialColor('6')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:201px">第
					6 章 树和二叉树</div>
				<hr style="width:180px; position:absolute; top:230px;margin:0px" />
				<div class="7" onclick="initialColor('7')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:231px">第
					7 章 图</div>
				<hr style="width:180px; position:absolute; top:260px;margin:0px" />
				<div class="8" onclick="initialColor('8')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:261px">第
					8 章 动态存储管理</div>
				<hr style="width:180px; position:absolute; top:290px;margin:0px" />
				<div class="9" onclick="initialColor('9')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:291px">第
					9 章 查找</div>
				<hr style="width:180px; position:absolute; top:320px;margin:0px" />
				<div class="10" onclick="initialColor('10')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:321px">第
					10 章 内存排序</div>
				<hr style="width:180px; position:absolute; top:350px;margin:0px" />
				<div class="11" onclick="initialColor('11')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:351px">第
					11 章 外部排序</div>
				<hr style="width:180px; position:absolute; top:380px;margin:0px" />
				<div class="12" onclick="initialColor('12')" style="font-size:14px; width:180px; text-align:center; height:30px; line-height:30px;background:#ffffff;font-family:Arial;color: #2e4358;position: absolute;top:381px">第
					12 章 文件</div>
